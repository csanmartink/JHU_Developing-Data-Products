...
```{r packages, error=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
map <- leaflet() %>%
        ...
        addMarkers(lat = -33.457737, lng = -70.664718, popup = "University of Chile - Department of Computer Sciences") %>% 
        addMarkers(lat = -33.496518, lng = -70.607781, popup = "Pontifical Catholic University of Chile - Department of Computer Sciences") %>% 
        addMarkers(lat = -33.034718, lng = -71.596716, popup = "Federico Santa María Technical University - Department of Informatics") %>% 
        addMarkers(lat = -36.830859, lng = -73.036740, popup = "University of Concepción -  Department of Computer Science")
map
```
